                    ...
                    <div className="col-12 col-md-7">
                        <Form>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" name="phone" id="phone" placeholder="with a placeholder" />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                            ...
                            <FormGroup row>
                                <Col md={{ size: 6, offset: 2 }}>
                                    <FormGroup check>
                                        <Label check>
                                            <Input type="checkbox" name="agree" /> <strong>May we contact you?</strong>
                                        </Label>
                                    </FormGroup>
                                </Col>
                            ...
                            <FormGroup>
                                <Col md={{ size: 10, offset: 2 }}>
                                    <Button type="button" color="primary">Send Feedback</Button>
                                </Col>
                            </FormGroup>
                        </Form>
                    </div>
